...
const ProjectCard = ({ projectImg, projectName, setIsProductViewOpen }: Props) => {
	...
	return (
		<div onClick={() => setIsProductViewOpen({ img: projectImg, name: projectName })} className='animate-slide-in-down delay-500 rounded-2xl relative w-full group overflow-hidden  md:w-80 my-4 mx-2 transform transition duration-500 hover:scale-110'>
